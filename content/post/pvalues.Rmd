...
```{r}
# We use Lukas Burk, Tobias Anton, Daniel Lüdecke, and Gesa Graf's 
...
So hypothsis testing consists of three main components

  1. A set of observed data: ${\bf x} = (x_1,\ldots,x_n)^T$, say.

  2. A hypotesised distribution for the data $X_i \sim F$ 
  which is often referred to as the null hypothesis denoted $H_0$, i.e.,
  $$
  H_0 \colon X_i \sim F.
  $$
  
  3. A test statistic: This is some function $T$ of the data ${\bf x}$, i.e.,
  $T(x_1,\ldots,x_n)\equiv T({\bf x})$ typically chosen so that large values of 
  $T({\bf x})$ suggest that the chosen hypotesised distribution in 2. is not 
