...
# Does skewed densities kill the two sample t-test

We are going to simulate data from two skewed normal densities.
There are a number of different skewed normal densities. We will
...
for (i in 1:N)
{
  # Simulate a skew-normal with mean 0
  # for the x's and the y's. One pos skewed
  # the other neg skewed
